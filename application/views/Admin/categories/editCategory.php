    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 mt-5">
                <form action="<?php echo base_url('admin/categories/update/').$category->id ?>" method="POST">
                    <div class="form-group">
                        <label for="">Category Name :</label>
                        <input type="text" value="<?php echo $category->name ?>" name="name" class="form-control mt-2">
                    </div>
